...
irrelevantes = [
    ...
    ("Projeto social transforma vidas através da educação", []),
    ...
    ("ONG resgata animais silvestres afetados por queimadas no Pantanal", []),
    ("Arquiteto brasileiro projeta edifício sustentável premiado na Europa", []),
